 ...
 */
public final class SunriseSunsetUtils {

    final static String TAG = SunriseSunsetUtils.class.getSimpleName();
    ...
    public static Calendar[] getSunriseSunset(final Calendar day,
        ...
        Log.d(TAG,"GET timezone "+day.getTimeZone().toString());
     ...
     */
    /**
     * The altitude of the sun (solar elevation angle) at the moment of golden hour: -4 ~ 6
     */
    public static final double SUN_ALTITUDE_GOLDEN_HOUR_START = -4.0;
    public static final double SUN_ALTITUDE_GOLDEN_HOUR_END = 6.0;

    public static Calendar[] getGoldenHours(final Calendar day,
                                                 final double latitude, double longitude) {
        Calendar[] goldenHourStart = getSunriseSunset(day, latitude, longitude, SUN_ALTITUDE_GOLDEN_HOUR_START);
        Calendar[] goldenHourEnd = getSunriseSunset(day, latitude, longitude, SUN_ALTITUDE_GOLDEN_HOUR_END);
        if(goldenHourStart == null || goldenHourEnd == null){
            return null;
        }
        else{
            return new Calendar[]{goldenHourStart[0],goldenHourEnd[0],goldenHourEnd[1],goldenHourStart[1]};
        }

    }

    /**
     * The altitude of the sun (solar elevation angle) at the moment of blue hour: -6~-4
     */
    public static final double SUN_ALTITUDE_BLUE_HOUR_START = -4.0;
    public static final double SUN_ALTITUDE_BLUE_HOUR_END = -6.0;

    public static Calendar[] getBlueHours(final Calendar day,
                                            final double latitude, double longitude) {
        Calendar[] hourStart = getSunriseSunset(day, latitude, longitude, SUN_ALTITUDE_BLUE_HOUR_START);
        Calendar[] hourEnd = getSunriseSunset(day, latitude, longitude, SUN_ALTITUDE_BLUE_HOUR_END);
        if(hourStart == null || hourEnd == null){
            return null;
        }
        else{
            return new Calendar[]{hourEnd[0],hourStart[0],hourStart[1],hourEnd[1]};
        }
